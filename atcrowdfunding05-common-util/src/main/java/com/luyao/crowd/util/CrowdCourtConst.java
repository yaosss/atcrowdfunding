...
public class CrowdCourtConst {
    ...
    public static final String MESSAGE_SYSTEM_ERROR_LOGIN_NOT_UNIQUE = "系统错误，账号重复";
    public static final String ATTR_NAME_PAGE_INFO = "pageInfo";
    public static final String MESSAGE_REMOVE_USER_ACCT = "不能删除自己的账号";
}
